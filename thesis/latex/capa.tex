...
\thispagestyle{empty} %Tirando o numero da primeira página
\vspace*{2.0cm}
\begin{center}
...
Dissertação de Mestrado apresentada na Faculdade de Engenharia Elétrica e de Computação como  parte dos
...
\begin{minipage}{7cm}
\small
Este exemplar corresponde a versão final da dissertação de mestrado apresentado pelo
