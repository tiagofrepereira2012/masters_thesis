...
Neste capítulo são apresentados os primeiros experimentos do estudo comparativo proposto no Capítulo \ref{cap:metodology}. O estudo foi aplicado em três contramedidas sendo duas explorando as características relativas a qualidade da imagem e uma relativa às características da cena. Os códigos fontes destas contramedidas estão livremente disponíveis na WEB e são elas:
...
\begin{table}[ht!]
\caption{Performance das três contramedidas utilizando o Protocolo de Avaliação Intra Teste}
\begin{center}
  \begin{tabular}{ | c | c |  c  c |  c  | c |}
    \hline

   \multirow{2}{*}{\textbf{Contramedida}} & \multirow{2}{*}{\textbf{Database}}  & \multicolumn{2}{c|}{\textbf{HTER(\%)}} &  \multirow{2}{*}{\textbf{FAR100 (\%)}} &  \multirow{2}{*}{\textbf{FAR1000 (\%)}} \\ 
...
\begin{table}[ht!]
\caption{Performance das três contramedidas aplicando o Protocolo de Avaliação Inter Teste}
\begin{center}
...
Pretende-se
As atividades que serão realizadas neste projeto são listadas a seguir:

\begin{enumerate}
        \item Desenvolvimento de contramedida 1;
        \item Desenvolvimento de contramedida 2;
        \item Desenvolvimento de contramedida 3;
