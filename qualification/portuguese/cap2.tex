...
A contramedida proposta por \cite{AnjosIJCB2011} mede a correlação do movimento da região da face em relação ao seu fundo utilizando como métrica de movimento uma simples diferença das intensidades dos pixels em quadros sucessivos. O movimento acumulado entre esta diferença ($M_D$), para um dado uma Região de Interesse (ROI) e seu respectivo fundo, é calculado usando a seguinte equação:
