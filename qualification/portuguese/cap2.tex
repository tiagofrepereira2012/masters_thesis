...
BLA BLA BLA introduzir a proxima seção.
...
Apoiado na hipótese que faces vivas apresentam, em certas regiões da face, padrões de movimento altamente descorelacionados do que ataques. Utilizando como referência a região do centro da face e a região das orelhas, \cite{kollreider2009non} desenvolveu uma heurística baseada em fluxo ótico para mensurar tal correlação como pode-se observar na Figura X.
