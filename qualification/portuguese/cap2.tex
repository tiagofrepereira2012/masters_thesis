...
Neste trabalho, as faces são segmentadas e geometricamente normalizadas para $64\times64$ pixels. Em seguida os parâmetros LBP configurado seguindo a configuração $LBP_{8,1}^{u2}$ são extraídos e histogramados. Estes histogramas são a entrada do classificador que detecta ataques.

A Tabela \ref{tb_LBP-Countermeasure} apresenta a performance do algoritmo em termos de HTER em três bases de dados de referência; a base de dados Replay Attack, a base de dados CASIA FASD e a base de dados NUAA utilizando SVM e LDA como classificadores.
